...
public:
    ...
    // Retorna um vetor com tuplas, onde cada tupla é da seguinte forma: X -> Y, suporte confiança
    ...
    // Retorna um conjunto, sem ordem e sem repetição dos elementos passados por parametro
...
int main (int argc, char **argv) {
    ...
    /* 
    Obtendo as transações no seguinte formato:
    vector<vector<int> > transactions = {
        {1, 2, 5},
        {2,4},
        {2,3},
    ...
    */    
    ...
    // Objeto para escrever as regras em um arquivo de saída
